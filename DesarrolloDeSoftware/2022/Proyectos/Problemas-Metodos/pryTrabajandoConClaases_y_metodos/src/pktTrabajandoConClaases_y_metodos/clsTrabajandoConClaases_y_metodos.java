		...
		switch(caso)
			{
				case 1:
						...
						System.out.println("\nResultado: "+metodo.mtdEnteroPotencia(base_p,exponente_p,multiplicacion_p,resultado_p));
						break;
				case 2:
						int numPrimo=0;
						char primo='S';
						...
						System.out.println("\nResultado: "+metodo.mtdPrimo(numPrimo,primo));
						break; 
				case 3:
						...
						System.out.println("\nResultado: "+metodo.mtdPerfecto(numPerfecto,xPerfecto,perfecto,esPerfecto));
						break;
				case 4:
						metodo.mtdFeliz();
						break;
				case 5:
						...
						System.out.println("\nResultado: "+metodo.mtdInvertir(numeroInvertir,invertido,restoInvertido));
						break;
				case 6:
						...
						System.out.println("\nResultado: "+metodo.mtdCifra(numCifra,cifra));
						break;
				case 7: 
						int xUlam=0;
						...
						System.out.println("\nResultado: "+metodo.mtdUlam(xUlam));
						break;
				case 8:
						...
						System.out.println("\nResultado: "+metodo.mtdAbundante(sumaAbun,numAbun,abundante));
						break;
				case 9:
						...
						System.out.println("\nResultado: "+metodo.mtdArmstrong(c_Armstrng,a_Armstrng,temp_Armstrng,n_Armstrng,strong));
						break;
				case 10:
						int num_PoI;
						char parImpar=' ';
						...
						System.out.println("\nResultado: "+metodo.mtdParImpar(num_PoI,parImpar));
						break;
				case 11:
						int num_factor;
						double factorial=0;
						...
						System.out.println("\nResultado: "+metodo.mtdFactorial(num_factor,factorial));
						break;
				case 12:
						...
						System.out.println("\nResultado: "+metodo.mtdAmigos(i_amigos,suma_amigos,n1_amigos,n2_amigos,amigos));
						break;
				case 13:
						...
						System.out.println("\nResultado: "+metodo.mtdCapicua(num_cap,aux_cap,inverso_cap,cifra_cap,capicua));
						break;
				case 14:
			...
			System.out.print("\nSi desea ejecutar otro metodo ingrese 1, si desea finalizar ingrese 0: ");
